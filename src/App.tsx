...
const App: FC = () => (
  <div className="container mx-auto px-4 my-4">
    ...
    <div className="card bg-base-100 shadow-xl my-10">
      <main className="card-body items-center text-center">App goes here</main>
    </div>
    ...
    <footer className="text-xs">
      ...
      <p className="mt-4">
        ...
        informational purposes only. No material on this site is intended to be
        ...
        something you have read on this website or in the source code.
      </p>
    </footer>
  </div>
);
